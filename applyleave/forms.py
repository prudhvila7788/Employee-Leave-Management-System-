...
class LeaveApplicationForm(forms.ModelForm):
    ...
    reason =forms.CharField(label='Comments', max_length=200, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    comments = forms.CharField(label='Comments', max_length=200, required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    #forms.ModelChoiceField(queryset=LeaveReason.objects.order_by('leave_reason').all().distinct(), label='Leave Reason',
